							...
							<div class="col-md-12 no-pad">
								...
								<div class="col-md-6 no-pad">
									<fieldset><legend class="screen-reader-text"><span><?php _e('Maximum width and height', WSIO_TEXT_DOMAIN );?></span></legend>
										...
										<input style="margin-right: 10px; display: initial; width: 10%;" class="form-control" name="wsio_image_width" id="wsio_image_width" type="text" value="<?php echo $wl_wsio_options['wsio_image_width']; ?>">
										<label><?php _e('Max height : ', WSIO_TEXT_DOMAIN );?></label>
										<input style="display: initial; width: 10%;" class="form-control" name="wsio_image_height" id="wsio_image_height" type="text" value="<?php echo $wl_wsio_options['wsio_image_height']; ?>">
									</fieldset>
									</br>
						...
						<div class="col-md-12 no-pad">
							<div class="col-md-12 no-pad">
								...
								<div class="col-md-6 no-pad">
									...
									<input class="form-control hc_range" type="range" step="1" min="1" max="100" value="<?php echo $wl_wsio_options['wsio_image_quality']; ?>">
									...
									<p style="margin:10px 0px;"><b style="margin-left: 5px; font-size: 15px;"><?php _e('%', WSIO_TEXT_DOMAIN );?></b></p>
									</br>
